...
export const GET_USER_REPLY_REQUEST="GET_USER_REPLY_REQUEST";
export const GET_USER_REPLY_SUCCESS="GET_USER_REPLY_SUCCESS";
export const GET_USER_REPLY_FAILURE="GET_USER_REPLY_FAILURE";